...
<?php	
	...
	$sql = 'SELECT * FROM tbl_products_a167688_pt2 WHERE fld_product_name LIKE :keyword OR fld_product_price LIKE :keyword OR fld_product_brand LIKE :keyword ORDER BY fld_product_id DESC ';
